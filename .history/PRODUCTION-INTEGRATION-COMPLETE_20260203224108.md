...
export const COMPANY_CONFIG = {
  ...
  phone: 'YOUR_BUSINESS_PHONE',
  email: 'contact@rosstaxprep.com',
  website: 'https://rosstaxprep.com'
}
```
...
curl https://rosstaxprep.com/api/bank-products/available

# Select refund advance (requires auth token)
curl -X POST https://rosstaxprep.com/api/bank-products/select \
...
```bash
# Get refund status
curl https://rosstaxprep.com/api/irs/refund-status/CLIENT_UUID/2025 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Get amended return status
curl https://rosstaxprep.com/api/irs/amended-status/CLIENT_UUID/2025 \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"
```
...
curl https://rosstaxprep.com/api/notifications/unread \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Get notification count
curl https://rosstaxprep.com/api/notifications/count \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Send custom notification (admin only)
curl -X POST https://rosstaxprep.com/api/notifications/send \
