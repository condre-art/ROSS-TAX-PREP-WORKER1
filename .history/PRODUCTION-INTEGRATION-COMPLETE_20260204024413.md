...
- **State**: Arkansas
- **EIN**: 33-4891499
- **(electronic filing identification number)**: 748335
...
- `GET /api/irs/-redirhttps://sa.www4.irs.gov/wmar//:clientId/:taxYear` - Redirect to IRS https://sa.www4.irs.gov/wmr/ WMAR with encrypted SSN
- `GET /api/irs/wmr-redirect/:clientId/:taxYear` - Redirect to IRS WMR with encrypted SSN https://www.irs.gov/refunds
